...
public class Shaman extends Villager {
	private final static String IMAGE = "assets/units/shaman.png";
	private final static String NAME = "Elvira";
	private final static int COOLDOWN = 0;
	private final static int DAMAGE = 0;
	private final static int HEALTH = 1;

	/**
	 * Creates a new Shaman object
	 *
	 * @param x
	 *            : x-coordinate
	 * @param y
	 ...
	 */
	public Shaman(double x, double y) throws SlickException {
